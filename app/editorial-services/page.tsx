...
const ServiceCard = ({ title, description, image, deliverables, index }: ServiceCardProps) => {
  return (
    <ScrollReveal
      delay={index * 80}
...
export default function EditorialServicesPage() {
  const editorialServicesList = [
    {
      title: "Developmental Editing",
      description: "Clarify structure, argument flow, pacing, and core audience. We help you shape the architecture of your manuscript to highlight its central promise.",
      image: "/vintage-studio.png",
      deliverables: [
        "Outline mapping & structural reports",
        "Narrative pacing & argument checks",
        "Target readership diagnostics",
        "Section-by-section developmental critique",
      ],
    },
    {
      title: "Line Editing & Craft",
      description: "Refine sentence-level craftsmanship. We improve flow, vocabulary consistency, rhythm, and syntax transitions without erasing your authentic voice.",
      image: "/desk-books.png",
      deliverables: [
        "Syntax flow & transition refinement",
        "Rhythm, tone, and sentence pacing polish",
        "Precision edits & vocabulary consistency",
        "Detailed style-guide alignment check",
      ],
    },
    {
      title: "Editorial Review",
      description: "A comprehensive readerly diagnostic. Receive a detailed report analyzing your writing's structural strengths, risks, and recommended revision paths.",
      image: "/desk-essay.png",
      deliverables: [
        "10-15 page editorial diagnostic report",
        "Structural risk & opportunity assessment",
        "Detailed margin-notes on sample chapters",
        "1-on-1 feedback consultation options",
      ],
    },
  ];
      ...
      <main>
        ...
        <section className="relative w-full h-[80vh] min-h-[500px] flex items-center justify-center text-center overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            <Image
              src="/desk-studio.png"
              alt="Editorial studio desk with notebooks and reading materials"
              fill
              priority
          ...
          <div className="relative z-10 max-w-4xl px-6 flex flex-col items-center">
            <ScrollReveal>
              ...
              <p className="font-serif-body text-[#FAF6F0]/90 text-[15px] sm:text-lg leading-[1.8] max-w-2xl font-medium">
                Developmental editing, line editing, proofreading, and content reviews that respect the voice and mind behind the manuscript.
              </p>
        ...
        {/* Section 2: Services Showcase Grid */}
        <section id="services-grid" className="w-full py-24 px-6 sm:px-12 max-w-7xl mx-auto">
          {/* Header */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-10 pt-4">
            {editorialServicesList.map((service, index) => (
              <ServiceCard
                key={service.title}
                title={service.title}
        ...
        {/* Section 3: Philosophy ("Our Philosophy") */}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 pt-6">
              ...
              <ScrollReveal className="flex flex-col items-center text-center group">
                <div className="relative w-20 h-20 mb-6 transition-transform duration-300 group-hover:scale-105">
                  <Image
                    ...
                    alt="Protecting Originality icon"
                    fill
                    sizes="80px"
                ...
                <p className="font-serif-body text-[14px] sm:text-[15px] leading-relaxed text-[#2E2522]/85 font-medium max-w-[280px]">
                  Good editing does not flatten. We believe in showing what the work wants to become, protecting the author's unique voice.
                </p>
              </ScrollReveal>
              ...
              <ScrollReveal delay={90} className="flex flex-col items-center text-center group">
                ...
                <p className="font-serif-body text-[14px] sm:text-[15px] leading-relaxed text-[#2E2522]/85 font-medium max-w-[280px]">
                  Sentence-level discipline meets deep academic and readerly care, ensuring that every sentence serves a purpose.
                </p>
              </ScrollReveal>
              ...
              <ScrollReveal delay={180} className="flex flex-col items-center text-center group">
                ...
                <p className="font-serif-body text-[14px] sm:text-[15px] leading-relaxed text-[#2E2522]/85 font-medium max-w-[280px]">
                  A supportive feedback process that leaves final authorship and creative control completely in the writer's hands.
                </p>
              </ScrollReveal>
            </div>
          </div>
        ...
        <section className="relative w-full bg-[#9E3E26] text-[#FAF6F0] py-24 px-6 sm:px-12 text-center overflow-hidden">
          ...
          <ScrollReveal className="relative z-10 max-w-2xl mx-auto flex flex-col items-center">
            ...
            <p className="font-serif-body text-base leading-[1.8] text-[#FAF6F0]/85 max-w-xl mb-8">
              Spaces for manuscripts and reviews are structured around editorial care. Schedule an initial consultation or share details of your draft.
            </p>
            <Link
              href="/contact"
