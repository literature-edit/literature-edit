...
export default function StudioSection() {
  return (
    <section className="relative w-full bg-[#FCFAF7] border-y border-[#D1C2B0]/30 py-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center relative z-10">
        ...
        <div className="lg:col-span-6 flex flex-col justify-center">
          ...
          <h2 className="font-display text-3xl sm:text-4xl font-light text-[#963D26] mt-3 tracking-[0.08em]">
            A LITERARY STUDIO
          </h2>
          ...
          <div className="flex items-center gap-3 my-6">
            ...
            <div className="w-1.5 h-1.5 rounded-full bg-[#963D26]" />
            <div className="h-[0.75px] w-24 bg-[#C5A880]/50" />
          </div>

          <div className="font-serif-body text-[#2A2421]/90 text-sm sm:text-[15px] leading-[1.75] space-y-6 max-w-xl">
            <p className="font-semibold text-[#963D26]/90">
          ...
          <div className="mt-8">
            <a
              href="#about"
              className="inline-flex items-center gap-2 font-display text-[10px] tracking-[0.2em] font-semibold text-[#963D26] hover:text-[#80311D] transition-colors group uppercase"
            >
